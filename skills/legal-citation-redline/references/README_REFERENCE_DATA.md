...
This public package is designed around 《法学引注手册》（2019年11月版） / Law Journal Citation Handbook, Second Edition. The original local filename used by the full workflow is:
...
builds the 1-100 rule index, writes the readable Markdown index and basic
...
```text
docs/法学引注手册本地配置说明.md（若该文档随仓库分发）
```
